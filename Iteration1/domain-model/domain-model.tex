...
\begin{figure}
    ...
    \begin{tikzpicture}[node distance=3cm]
        ...
        \node[rectangle, draw, below=4cm of console] (lreg) {Location Registry};
        %\node[rectangle, draw, below=of console, text height=0.8cm, text depth=0.7cm, align=center] (lreg) {Location Registry};
        ...
        \node[rectangle, draw, right=of sreg, text width=4cm, align=center] (sensor) {
            Sensor \\
        ...
        \node[rectangle, draw, below left=3cm and 1cm of sensor, text width=4cm, align=center] (loc) {
            Location \\
            \rule{\linewidth}{0.4pt} \\
            longitude: Real\\
            latitude: Real
        ...
        % Map Entity
        \node[rectangle, draw, below=8cm of sensor] (map) {Map};
        
        % Map Table Entity
        \node[rectangle, draw, below=3.25cm of loc] (mapt) {Map Table};
        ...
        \draw[-] (console.west)  -- (-2, 0) -| (-2, -9) -| (mapt.west) node[left=0.2cm of console,above]{1} node[below=8.25cm of console]{Accesses} node[left=0.2cm of mapt,above]{1};
        
        % Connect Console to Read Table
        \draw[-] (console.north)  -- (0, 3) -| (readt.west) node[above=0.2cm of console,left] {1} node[above=3cm of console, right] {Accesses} node[left=0.2cm of readt,above]{1};
