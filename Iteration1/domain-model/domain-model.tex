...
\begin{figure}
    ...
    \begin{tikzpicture}[node distance=3cm]
        ...
        \node[rectangle, draw, below left=4cm and 1cm of sensor] (loc) {Location};
        
		% Location Map Entity
        \node[rectangle, draw, below=1.5cm of loc] (locmap) {Location Map};
        
        % Map Entity
        \node[rectangle, draw, below=8.4cm of sensor] (map) {Map};
        
        % Map Table Entity
        \node[rectangle, draw, below left=3.9cm and 1cm of loc] (mapt) {Map Table};
