...
\begin{figure}
	...
	\node[rectangle, draw, minimum width=2cm, minimum height=1cm, align=center] (loc) at (10, -13.25)  {:\underline{Location}};
  	...
  	%\draw[-{Straight Barb[length=2mm]}] (0, -14) -- (10,-14) node[midway, above] {add(l)};
  	 ...
  	 %Location List 
  	\node[rectangle, draw, minimum width=2cm, minimum height=1cm, align=center] (loclist) at (12, 0)  {:\underline{Location}};
  	\draw[dashed] (loclist.south) -- +(0,-17.3cm);
  	
  	
  		%creating a collection figure
  		\draw (11.2,0.5) -- (11.2, 0.7);
  		\draw (11.2, 0.7) -- (13.2,0.7);
  		\draw (13.2,0.7) -- (13.2,-0.2);
  		\draw (13.2,-0.2) -- (13,-0.2); 
  		
  		\draw[-{Straight Barb[length=2mm]}] (0, -14) -- (12,-14) node[midway, above] {add(1)};
